...
const WaterLogSchema = CollectionSchema(
  ...
  properties: {
    ...
    r'unit': PropertySchema(
      ...
      enumMap: _WaterLogunitEnumValueMap,
    )
  },
...
P _waterLogDeserializeProp<P>(
  ...
  switch (propertyId) {
    ...
    case 2:
      return (_WaterLogunitValueEnumMap[reader.readStringOrNull(offset)] ??
          Units.millilitres) as P;
    default:
      throw IsarError('Unknown property with id $propertyId');
  }
}

const _WaterLogunitEnumValueMap = {
  r'pound': r'pound',
  r'ounce': r'ounce',
...
const _WaterLogunitValueEnumMap = {
  r'pound': Units.pound,
  r'ounce': Units.ounce,
...
extension WaterLogQueryFilter
  ...
  QueryBuilder<WaterLog, WaterLog, QAfterFilterCondition> unitEqualTo(
    Units value, {
  ...
  QueryBuilder<WaterLog, WaterLog, QAfterFilterCondition> unitGreaterThan(
    Units value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<WaterLog, WaterLog, QAfterFilterCondition> unitLessThan(
    Units value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<WaterLog, WaterLog, QAfterFilterCondition> unitBetween(
    Units lower,
    Units upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<WaterLog, WaterLog, QAfterFilterCondition> unitStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<WaterLog, WaterLog, QAfterFilterCondition> unitEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<WaterLog, WaterLog, QAfterFilterCondition> unitContains(
      String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<WaterLog, WaterLog, QAfterFilterCondition> unitMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<WaterLog, WaterLog, QAfterFilterCondition> unitIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'unit',
        value: '',
  ...
  QueryBuilder<WaterLog, WaterLog, QAfterFilterCondition> unitIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.greaterThan(
        property: r'unit',
        value: '',
...
extension WaterLogQuerySortBy on QueryBuilder<WaterLog, WaterLog, QSortBy> {
  ...
  QueryBuilder<WaterLog, WaterLog, QAfterSortBy> sortByUnit() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'unit', Sort.asc);
    });
  }

  QueryBuilder<WaterLog, WaterLog, QAfterSortBy> sortByUnitDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension WaterLogQuerySortThenBy
  ...
  QueryBuilder<WaterLog, WaterLog, QAfterSortBy> thenByUnit() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'unit', Sort.asc);
    });
  }

  QueryBuilder<WaterLog, WaterLog, QAfterSortBy> thenByUnitDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'unit', Sort.desc);
    });
  }
...
extension WaterLogQueryWhereDistinct
  ...
  QueryBuilder<WaterLog, WaterLog, QDistinct> distinctByUnit(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension WaterLogQueryProperty
  ...
  QueryBuilder<WaterLog, Units, QQueryOperations> unitProperty() {
    return QueryBuilder.apply(this, (query) {
